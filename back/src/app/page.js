    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-xl font-semibold mb-2">1. Authentification</h2>
            <p className="mb-2">Endpoint: <code className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded">POST /api/login</code></p>
            <p>Permet de vérifier les identifiants de connexion d&apos;un utilisateur.</p>
...
{`fetch('https://crudapi-red.vercel.app/api/login', {
  ...
  body: JSON.stringify({
    ...
    "mdp": "password123"
              ...
              <div>
                <h3 className="font-medium mb-1">Réponse (succès) :</h3>
                <pre className="bg-black/[.05] dark:bg-white/[.06] p-4 rounded">
{`{
  "success": true,
  "data": {
    ...
    "type": "admin"
              ...
              <div>
                <h3 className="font-medium mb-1">Réponse (erreur) :</h3>
                <pre className="bg-black/[.05] dark:bg-white/[.06] p-4 rounded">
{`{
  "error": "Identifiants invalides"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">2. Liste des utilisateurs</h2>
            <p className="mb-2">Endpoint: <code className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded">GET /api/users</code></p>
            <p>Permet de récupérer la liste de tous les utilisateurs.</p>
            <div className="space-y-4">
              <div>
                <h3 className="font-medium mb-1">Requête :</h3>
                <pre className="bg-black/[.05] dark:bg-white/[.06] p-4 rounded">
  ...
  "data": [
    ...
    },
    {
      ...
      "type": "user"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">3. Création d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur créé avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">4. Suppression d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur supprimé avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">5. Modification d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur modifié avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">6. Vérification du type d&apos;utilisateur</h2>
