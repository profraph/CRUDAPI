    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-xl font-semibold mb-2">1. Liste des utilisateurs</h2>
  ...
  "data": [
    ...
    },
    {
      ...
      "type": "user"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">2. Création d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur créé avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">3. Suppression d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur supprimé avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">4. Modification d&apos;utilisateur</h2>
...
{`{
  ...
  "message": "Utilisateur modifié avec succès"
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">5. Vérification du type d&apos;utilisateur</h2>
